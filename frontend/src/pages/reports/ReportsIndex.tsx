...
export const ReportsIndex: React.FC = () => {
  return (
    <div className="flex flex-col w-full px-space-md md:px-space-xl py-space-lg max-w-content-max-width mx-auto space-y-space-lg text-[18px]">
      <div>
        <h1 className="font-display-lg text-[34px] font-extrabold text-brand-navy-deep tracking-tight">Reports & Analytics</h1>
        <p className="font-body-md text-[18px] text-on-surface-variant mt-0.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-md">
        {REPORT_CARDS.map((report) => (
          ...
          >
            ...
            <h3 className="font-headline-sm text-brand-navy-deep mb-2 group-hover:text-primary transition-colors">
              {report.title}
            </h3>
